...
# Usage: MYTHRAS_GM_CLI="uv run python /path/to/mythras_gm.py" bash setting/seed_veilwrack.sh
...
set -euo pipefail
CLI="${MYTHRAS_GM_CLI:-uv run python skills/mythras-gm/mythras_gm.py}"
